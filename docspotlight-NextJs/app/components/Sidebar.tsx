...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  useEffect(() => {
    const checkScreenSize = () => {
      ...
      setIsTabletOrMobile(window.innerWidth <= 1024) // Include tablets
    }
                ...
                >
                  ...
                  >
                    ...
                    {item.isCollection ? (
                      ...
                      <div className="w-6 h-4 bg-gradient-to-br from-neutral-700 to-neutral-800 rounded flex items-center justify-center p-2">
                        <span className="text-white text-[8px] font-extrabold leading-none tracking-wide">PDF</span>
                      </div>
                    )}
                  </motion.div>
                    ...
                    <motion.button
                      ...
                      className={`w-7 h-7 rounded-md flex items-center justify-center transition-all duration-200 ${
                        activeMenu === item.id
                          ...
                          : isTabletOrMobile 
                            ? 'opacity-100 hover:bg-neutral-700 bg-neutral-800/50' 
                      ...
                      {activeMenu === item.id && (
                        <>
                          ...
                          <motion.div
                            ...
                            className={`absolute right-0 top-8 z-[101] bg-neutral-800 border border-neutral-600 rounded-lg shadow-xl overflow-hidden ${
                              isTabletOrMobile ? 'w-48' : 'w-40'
                            }`}
                          >
                            <div className="py-1">
                              <button
                                ...
                                className={`w-full text-left text-neutral-200 hover:text-white hover:bg-neutral-700 transition-colors flex items-center gap-3 ${
                                  isTabletOrMobile ? 'px-4 py-3 text-base' : 'px-4 py-2.5 text-sm'
                                }`}
                              >
                                <svg width={isTabletOrMobile ? "18" : "16"} height={isTabletOrMobile ? "18" : "16"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="flex-shrink-0">
                              ...
                              <button
                                ...
                                className={`w-full text-left text-red-400 hover:text-red-300 hover:bg-neutral-700 transition-colors flex items-center gap-3 ${
                                  isTabletOrMobile ? 'px-4 py-3 text-base' : 'px-4 py-2.5 text-sm'
                                }`}
                              >
                                <svg width={isTabletOrMobile ? "18" : "16"} height={isTabletOrMobile ? "18" : "16"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="flex-shrink-0">
